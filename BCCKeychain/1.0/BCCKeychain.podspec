Pod::Spec.new do |s|
  ...
  s.description      = <<-DESC
                       ...
                       * Don't worry about the indent, we strip it!
                       DESC
  s.homepage         = 'https://github.com/brooklyncomputerclub/BCCKeychain'                           #主页,这里要填写可以访问到的地址，不然验证不通过
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'           #截图
  s.license          = 'MIT'              #开源协议
  s.author           = { 'Jarek' => '373330163@qq.com' }                   #作者信息
  s.source           = { :git => 'https://github.com/brooklyncomputerclub/BCCKeychain.git', :branch => 'master' }      #项目地址，这里不支持ssh的地址，验证不通过，只支持HTTP和HTTPS，最好使用HTTPS
  ...
  # s.dependency 'GTMBase64', '>=0'   #依赖关系，该项目所依赖的其他库，如果有多个需要填写多个s.dependency
